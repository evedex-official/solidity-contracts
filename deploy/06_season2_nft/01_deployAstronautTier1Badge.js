...
module.exports = migration(async (deployer) => {
  const id = 'astronaut_tier_1';
  const totalSupply = 3; // 50000
  const name = "Astronaut Badge v1";
  const symbol = "ASTROv1"
  const uri = "https://badges.eventhorizon.tech/metadata/37bacc_astronaut_tier_1/";
