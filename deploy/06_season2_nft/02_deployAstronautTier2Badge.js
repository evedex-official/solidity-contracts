...
module.exports = migration(async (deployer) => {
  const id = 'astronaut_tier_2';
  const totalSupply = 5; // 50000
  const name = "Astronaut Badge v2";
  const symbol = "ASTROv2"
  const uri = "https://badges.eventhorizon.tech/metadata/cdf19c_astronaut_tier_2/";
